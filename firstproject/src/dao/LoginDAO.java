...
public class LoginDAO {
	...
	public Map<String, Object> login(String id, String pass){ // Map 타입 반환
		// 로그인
		...
		String sql = "SELECT * FROM TMEMBER WHERE MEM_ID = ? AND MEM_PASS = ?"; // 동적쿼리
		List<Object> param = new ArrayList<Object>();
		param.add(id);
		param.add(pass);
		
		return jdbc.selectOne(sql, param); //서비스로 넘겨줌
	}
}
